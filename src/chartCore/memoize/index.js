...
export const getMemoizeTypes = () =>
  getMemoize(rerunChecks.rerunCheckGetTypes, getTypes);
export const getMemoizeDomains = () =>
  getMemoize(rerunChecks.rerunCheckGetDomains, getDomains);
export const getMemoizePlotRect = () =>
  getMemoize(rerunChecks.rerunCheckGetPlotRect, getPlotRect);
export const getMemoizeRanges = () =>
  getMemoize(rerunChecks.rerunCheckGetRanges, getRanges);
...
export const getMemoizeScales = () =>
  getMemoize(rerunChecks.rerunCheckGetScales, getScales);
